                                        ...
                                        <tr>
                                            ...
                                            <td align="center" style="width: 135px;">
                                                <button type="button" class="btn btn-success"> <a
                                                        href="auditee-tersedia.php?id=<?php echo $row['UNIT']; ?>"
                                                        style=" color: white; text-decoration: none;">Mulai
                                                        Audit</a></button><br>
                                                <button type="button" class="btn btn-primary mt-2"> <a
                                                        href="auditee-tersedia.php?id=<?php echo $row['UNIT']; ?>"
                                                        style=" color: white; text-decoration: none;">Peta Mutu</a></button>

                                            </td>
                                            <td style="width: 60px;">
                                                <button type="button" class="btn btn-warning"> <a
                                                        href="auditor-tersedia.php?id=<?php echo $row['UNIT']; ?>"
                                                        style=" color: white; text-decoration: none;">Form</a></button>
                                            </td>
                                        </tr>
                                        <?php
                                    }
